...
import LogFilterBar from '@/components/debug-log/LogFilterBar';
import LogStatsCards from '@/components/debug-log/LogStatsCards';
import LogTable from '@/components/debug-log/LogTable';
import LogPagination from '@/components/debug-log/LogPagination';
import LogDetailModal from '@/components/debug-log/LogDetailModal';
import { StatusType } from '@/components/debug-log/utils';

interface LogQueryPageProps {
  onLogout?: () => void;
  isLoginMode?: boolean;
}

export default function LogQueryPage({ onLogout, isLoginMode = false }: LogQueryPageProps) {
  // 基础数据
    ...
    <div className="flex h-screen flex-col bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100 overflow-hidden">
      ...
      <header className="flex items-center justify-between border-b border-gray-200 dark:border-gray-800 bg-white dark:bg-gray-800 px-4 py-3 shadow-sm">
        <div className="flex items-center gap-2">
          ...
          <h1 className="text-xl font-bold">ESM 日志查询</h1>
        </div>
        {isLoginMode && (
          <button
            onClick={onLogout}
      ...
      <main className="flex-1 overflow-auto p-6">
        <div className="space-y-6">
          <div className="flex items-center justify-between">
            <h2 className="text-2xl font-bold">处理记录查询</h2>
